...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("EMODnet/emodnet.wfs", fork = TRUE)`.
...
Regular contributors should be listed in inst/collaborators.txt to
ensure the user-agent used by the package flags them as developers.
